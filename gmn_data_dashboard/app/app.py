...
from gmn_python_api.trajectory_summary_reader import read_trajectory_summary_as_dataframe, DATETIME_FORMAT
...
def update_output(value):
    ...
    trajectory_summary_file_content = get_daily_file_content_by_date(datetime.strptime(value, "%Y-%m-%d"))
    trajectory_summary_dataframe = read_trajectory_summary_as_dataframe(trajectory_summary_file_content)
    # minus 90 from every row
